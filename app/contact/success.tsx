    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900">
      ...
      <section className="py-20 bg-gradient-to-br from-slate-800 via-blue-900 to-indigo-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-white mb-12 text-center">ماذا يحدث الآن؟</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">مراجعة الرسالة</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">الرد الأولي</h3>
              <p className="text-slate-300">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">استشارة مجانية</h3>
              <p className="text-slate-300">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">خطة مخصصة</h3>
              <p className="text-slate-300">
          ...
          <div className="bg-slate-800/50 backdrop-blur-lg rounded-2xl p-8 border border-slate-700/50">
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-white mb-1">الرد السريع</h3>
                  <p className="text-slate-300">نلتزم بالرد على جميع الرسائل خلال 24 ساعة عمل</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-white mb-1">تحقق من بريدك</h3>
                  <p className="text-slate-300">سيصلك ردنا على البريد الإلكتروني الذي قدمته</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-white mb-1">استشارة مجانية</h3>
                  <p className="text-slate-300">جميع استشاراتنا الأولية مجانية تماماً</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-slate-800 via-blue-900 to-indigo-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-white mb-6">هل لديك أسئلة إضافية؟</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <div className="bg-slate-800/50 backdrop-blur-lg rounded-lg p-6 border border-slate-700/50">
              <div className="text-blue-400 font-semibold mb-2">الهاتف والواتساب</div>
              <div className="text-white text-xl">+49 123 456789</div>
            </div>
            <div className="bg-slate-800/50 backdrop-blur-lg rounded-lg p-6 border border-slate-700/50">
              <div className="text-blue-400 font-semibold mb-2">البريد الإلكتروني</div>
